    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.2 * 1000} style={{ marginTop: "2rem", marginBottom: "2rem" }}>
          <p>I worked as an SDE-I at Jio Platforms, where I contributed to the Domain Analytics module of the CloudXp platform. I designed and developed data-driven UI dashboards using Angular, HTML, CSS, and JavaScript, integrating APIs and visualizing cloud usage data to support business insights. I collaborated closely with cross-functional teams in an Agile environment, utilizing Git and Azure DevOps for efficient development workflows. Eager to continuously learn and grow, I was particularly passionate about building full-stack applications and solving real-world problems with clean, maintainable code.</p>
        </ScrollAnimation>
